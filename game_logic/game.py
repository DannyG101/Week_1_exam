...
def init_game() -> dict:
    ...
    #Create players
    human_player = create_player(input())
    ...
    human_player["hand"] = current_deck[:27]
    ai_player["hand"] = current_deck[27:]
...
def play_round(p1:dict,p2:dict):
    while p1["hand"] and  p2["hand"]:
        ...
        if current_round_results == "p1":
            ...
            p1["won_pile"].append(p1_card, p2_card)

        elif current_round_results =="p2":
            print("Player 2 takes the cards")
            p2["won_pile"].append(p1_card, p2_card)
